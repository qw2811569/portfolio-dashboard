# Current Work — History (pre-2026-04-27)

**已歸檔**：2026-04-28（R32 docs cleanup truncation）
**Source**：`docs/status/current-work.md` 原始 671 行 · 留 head（preferences + start-here + R106 sweep + 30 latest entries）作為 active · 此檔保留 line 126-671 的歷史 checkpoint 體（R104-R141 sprint trail）作考古用。
**Reason**：current-work.md 97 KB 過大 + 雙 "## Latest checkpoint" header（merge artifact）+ 大量 R104-R141 已收斂 entries · 影響新 session 載入 / 找重點。

**Active 入口**：`docs/NOW.md` + `docs/status/current-work.md`（slim 版）
