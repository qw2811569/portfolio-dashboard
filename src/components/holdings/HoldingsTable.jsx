...
export function HoldingRow({
  ...
  return h("div", null,
    ...
    h("div", {
      ...
      // Qty + Cost
      h("div", { style: { fontSize: 10, color: C.textSec } },
      ...
      h("div", {
        ...
        h("div", { style: { fontSize: 9, fontWeight: 500 } }, `${pct >= 0 ? "+" : ""}${pct.toFixed(2)}%`)
      ),
    ...
    expanded && h("div", {
      ...
      h("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 } },
        ...
        h("div", null,
          ...
          h("input", {
            ...
            onChange: (e) => onUpdateTarget(holding.code, e.target.value ? Number(e.target.value) : null),
            placeholder: "輸入目標價",
            style: {
              width: "100%",
              background: C.subtle,
      ...
      // Additional info
      holding.type && h("div", { style: { fontSize: 9, color: C.textMute, marginTop: 8 } },
        "類型：", holding.type
      )
    )
  );
...
export function HoldingsTable({
  ...
  if (!holdings || holdings.length === 0) {
    return h("div", { style: { ...card, textAlign: "center", padding: "32px 16px" } },
      h("div", { style: { fontSize: 28, marginBottom: 8, opacity: 0.6 } }, "∅"),
      h("div", { style: { fontSize: 11, color: C.textSec, fontWeight: 600 } }, "尚無持股"),
      h("div", { style: { fontSize: 10, color: C.textMute, marginTop: 4 } }, "上傳成交記錄或手動新增持股")
    );
  }
