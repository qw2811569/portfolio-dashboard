          ...
          ? h(
              ...
              h('div', {
                style: {
                  ...
                  height: 18,
                  borderRadius: 999,
                  background: `linear-gradient(90deg, ${alpha(C.blue, '10')}, ${alpha(C.blue, '28')}, ${alpha(C.blue, '10')})`,
              ...
              h('div', {
                style: {
                  ...
                  height: 12,
                  borderRadius: 999,
                  background: `linear-gradient(90deg, ${alpha(C.blue, '0c')}, ${alpha(C.blue, '20')}, ${alpha(C.blue, '0c')})`,
                  backgroundSize: '200% 100%',
                  animation: 'overview-kpi-skeleton 1.4s ease-in-out infinite',
                },
              })
