export function useAppRuntimeCoreArgs({ state, setters, ui, runtime, refs, helpers }) {
  return {
    ...
    setters: {
      ...
      setAnalysisHistoryStatus: setters.setAnalysisHistoryStatus,
      ...
      setResearchHistoryStatus: setters.setResearchHistoryStatus,
...
export function useAppRuntimeWorkflowArgs({
  ...
  return {
    ...
    derived: {
      ...
      todayTotalPnl: derived.todayTotalPnl,
      todayPnlHasPriceData: derived.todayPnlHasPriceData,
      todayPnlIsStale: derived.todayPnlIsStale,
      retPct: derived.retPct,
      marketPriceSync: derived.marketPriceSync,
