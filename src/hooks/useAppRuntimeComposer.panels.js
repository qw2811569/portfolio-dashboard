export function composePortfolioPanelsContextInput({
  ...
  return {
    ...
    todayPnlHasPriceData: data.todayPnlHasPriceData,
    todayPnlIsStale: data.todayPnlIsStale,
    ...
    x1BenchmarkState: data.x1BenchmarkState,
    analysisHistory: data.analysisHistory,
    analysisHistoryStatus: data.analysisHistoryStatus,
    ...
    researchHistoryStatus: data.researchHistoryStatus,
    ...
    setDetailStockCode: controls.setDetailStockCode,
