...
export const useReports = ({
  initialAnalysisHistory = [],
  initialDailyReport = null,
} = {}) => {
   ...
   */
  const deleteAnalysis = useCallback((reportId) => {
    if (!reportId) return;
   ...
   */
  const getAnalysisByDate = useCallback((date) => {
   ...
   * Get analysis by ID
   */
  const getAnalysisById = useCallback((id) => {
