...
export const ThesisPillarSchema = z
  .object({
    id: NullableString,
    name: NullableString,
    text: NullableString,
...
export const ThesisRiskSchema = z
  .object({
    id: NullableString,
...
export const ThesisScorecardSchema = z
  .object({
...
export const TargetReportSchema = z
  .object({
    firm: NullableString,
...
export const FundamentalsEntrySchema = z
  .object({
    code: NullableString,
...
export const HoldingDossierSchema = z
  .object({
    code: NonEmptyString,
    name: NonEmptyString,
...
export const OperatingContextSchema = z
  .object({
...
export const TradeParseRequestSchema = z.object({
