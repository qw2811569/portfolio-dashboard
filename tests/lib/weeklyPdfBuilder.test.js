...
import { buildWeeklyPdfData, buildWeeklyPdfDefinition } from '../../src/lib/weeklyPdfBuilder.js'

describe('lib/weeklyPdfBuilder', () => {
  it('builds weekly PDF data with compliant insider section for 7865', () => {
